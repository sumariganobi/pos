...
export default function Sidebar({ isMobileMenuOpen = false, setIsMobileMenuOpen }: SidebarProps = {}) {
  ...
  const toggleMenu = setIsMobileMenuOpen || setInternalMobileMenuOpen
      ...
      `}>
        ...
        <div className="p-4 border-b border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-base font-bold text-gray-900">POS System</h1>
        ...
        <div className="p-3 border-t border-gray-100">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2 text-sm text-red-600 hover:bg-red-50 rounded-lg font-medium transition-all active:scale-95"
          >
